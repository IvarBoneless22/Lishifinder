(()=>{
  ...
  const sourceLinks=[{name:"Original Lishi",url:"https://www.originallishi.com/lishi-tools-full-list/"},{name:"Genuine Lishi",url:"https://www.genuinelishi.com/"}];
  ...
  function makeComparisonPanel(record){
    ...
    if(!record._externalOnly)appendComparisonRow(panel,"LishiFinder",[record.years,(record.markets||[]).map(value=>marketNames[value]||value).join(", ")].filter(Boolean).join(" • ")||"Вбудований запис",ownCode);
